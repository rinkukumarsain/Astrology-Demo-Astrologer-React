            ...
            <div className="mt-6 flex items-center gap-3" onPaste={handleOtpPaste}>
              {otp.map((digit, index) => (
                <input
                  ...
                  className="size-[40px] md:size-[56px] rounded-[12px] border border-[#E4E4E4] bg-[#ECEDEF] text-center text-2xl font-semibold text-[#2D2D2D] outline-none focus:border-primary focus:bg-white"
                />
              ))}
            </div>
